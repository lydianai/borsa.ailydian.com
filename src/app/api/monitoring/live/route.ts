...
// DISABLED: Missing modules @/lib/alert-service and @/lib/bot-connector
...
export async function GET(_request: NextRequest) {
  // DISABLED: Missing @/lib/alert-service and @/lib/bot-connector modules
  return NextResponse.json(
    {
      success: false,
      error: 'Live monitoring endpoint is currently disabled. Missing backend dependencies.',
    },
    { status: 503 }
  );
...
export async function POST(_request: NextRequest) {
  ...
  return NextResponse.json(
    {
      success: false,
      error: 'Bot control endpoint is currently disabled. Missing backend dependencies.',
    },
    { status: 503 }
  );
